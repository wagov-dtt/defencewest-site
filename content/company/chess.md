...
- wheatbelt
latitude: -31.9931054
longitude: 115.9602843
---

## Overview

Chess Engineering is an Australian-owned fabrication and engineering company with a proud history of supporting defence, mining, and infrastructure sectors. Operating from our ISO-certified facilities in Welshpool, Western Australia, we deliver complex structural, mechanical, and modular steel projects to CC3 standards across the nation.

Our involvement in the defence sector extends through major subcontracting and fabrication works undertaken for Garden Island (NSW) naval base projects. These engagements, delivered in partnership with prime contractors, involved high-precision fabrication, modular assembly, and surface treatment of critical infrastructure supporting naval maintenance and refit operations. The success of these works demonstrated our capability to meet the stringent quality, traceability, and scheduling requirements demanded by defence clients.

Building on this foundation, Chess Engineering continues to expand its defence-ready capacity, maintaining fully integrated ISO 9001 (Quality), ISO 14001 (Environment), and ISO 45001 (Safety) management systems. Our team of experienced project managers, fabricators, and inspectors deliver across the full project lifecycle—from design and detailing to fabrication, coating, and installation—under rigorous quality control procedures and independent third-party verification.

We maintain specialist facilities for carbon, stainless, and alloy steels, with segregated bays for defence and critical works, and established relationships with qualified subcontractors and coating applicators throughout WA and interstate.
...
Recent defence experience includes fabrication and modular works for Garden Island (NSW) naval base infrastructure supporting fleet maintenance and shore-based upgrade programs. Scope encompassed heavy structural modules, precision pipe supports, and mechanical frames manufactured under tight tolerances and progressive inspection regimes. Deliverables were completed in partnership with prime contractors and verified through third-party QA and surface-treatment conformance.

Chess Engineering’s capability is reinforced by qualified welding inspectors, in-house project management, and experience delivering to defence documentation standards, including material certificates, inspection test plans, and MDR compilation. Our workforce is trained in confined-space, working-at-heights, and site-induction procedures for secure and high-risk environments.
